...
async def load_extensions():
    extensions = ["func.color_tile_game", "func.past_self", "func.save_messages", 'funcslash.wakeup', 'funcslash.yubaba', 'funcslash.activity_report', "func.echo_past_message", "func.Kaibunsyo"]
    loaded_extensions = []
